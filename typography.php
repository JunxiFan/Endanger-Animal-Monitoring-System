    ...
    <div class="container">
                ...
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="dropdown">
                        <a href="#" id="myTabDrop1" class="dropdown-toggle" data-toggle="dropdown"
                           aria-controls="myTabDrop1-contents" aria-expanded="false">Dropdown <span
                                    class="caret"></span></a>
      ...
      <span class="input-group-btn">
        ...
        <section id="tables">
            ...
            <p>For basic stylinglight padding and only horizontal add the base class <code>.table</code> to any <code>
                    &lt;table&gt;</code>.</p>
